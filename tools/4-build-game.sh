...
echo "INFO: Generating game build system..."
cmake \
    -S $GAME_BASE_PATH \
    -B $GAME_BUILD_PATH \
    -D SOURCE_PATH="$GAME_SOURCE_PATH" \
    -D FASTNOISELITE_INCLUDE_PATH="$GAME_FASTNOISELITE_INCLUDE_PATH" \
    ...
    -D SDL2_TTF_INCLUDE_PATH="$GAME_SDL2_TTF_INCLUDE_PATH" \
    -D SDL2_TTF_LIBRARY_PATH="$GAME_SDL2_TTF_LIBRARY_PATH" \
